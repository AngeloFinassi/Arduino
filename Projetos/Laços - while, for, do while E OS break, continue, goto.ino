#define pinBotao 2
//'goto' sai de um laço e faz com que o programa inicie outro laço, mas tem q estar endereçado tipo o letrasMaisuculas: Numeros: etc..
// e para definir os endereços é necessário colcoar antes do laço começar
